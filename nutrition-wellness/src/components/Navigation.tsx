...
import { Menu, X, Apple, ClipboardList, Refrigerator, Soup, BookMarked, PlusCircle, Lightbulb } from "lucide-react";
import { AnimatePresence, motion } from "framer-motion";

const menuItems = [
  { name: "Overview", href: "#overview", icon: Apple, color: "text-doom-primary" },
  { name: "Profile", href: "#profile", icon: ClipboardList, color: "text-doom-accent" },
  { name: "Pantry Planner", href: "#pantry", icon: Refrigerator, color: "text-green-400" },
  { name: "Dish Optimizer", href: "#optimizer", icon: Soup, color: "text-orange-400" },
  { name: "Recipe Library", href: "#library", icon: BookMarked, color: "text-blue-400" },
  { name: "Custom Recipe", href: "#custom", icon: PlusCircle, color: "text-indigo-400" },
  { name: "Insights", href: "#insights", icon: Lightbulb, color: "text-yellow-300" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="#overview" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-doom-text hidden sm:block">Nutrition Wellness</span>
            </Link>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-doom-primary/20">
                <h2 className="text-xl font-bold text-doom-text">Nutrition</h2>
                <button
                  onClick={() => setIsOpen(false)}
