...
export default function CommunityPage({ userId, userName }: { userId: string; userName: string }) {
  ...
  return (
    <>
    <Navigation user={{ userId, email: "", name: userName }} />
    <main className="min-h-screen bg-doom-bg pt-16">
      {/* Hero */}
        ...
        <div className="max-w-[95%] mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-doom-text tracking-tight">
                Wellness{" "}
          ...
          <div className="flex-1 min-w-0">
            ...
            {loading ? (
              ...
              >
                ...
                <h3 className="font-heading text-xl font-semibold text-doom-text mb-2">
                  {filterByUserId
